...
% Sudoku 6x6 (squares are 3x2)
sudoku_6x6(Problem, Solution) :-
    Solution = Problem, 
    
    Problem = [S11, S12, S13, S14, S15, S16, 
	...
	pprint([Row1, Row2, Row3, Row4, Row5, Row6]).

% Sudoku 9x9 solver
sudoku_9x9(Problem, Solution) :-
    Solution = Problem, 
    
    Problem = [S11, S12, S13, S14, S15, S16, S17, S18, S19,
